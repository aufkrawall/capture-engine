...
- DLL injection can trigger anti-cheat protection. The fresh profile warns users not to select `injection_mode=capture|overlay` for multiplayer/anti-cheat software unless it is permitted.

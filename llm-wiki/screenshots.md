...
Last cross-checked: 2026-08-18 (asynchronous D3D12 readback off the present thread, PostSL-ordered overlay-free/overlay-included capture, stale injected-source identity after game exit, presentation-contract-aware inject/WGC source encoding, native HDR versus forced-SDR output policy, bounded parallel/realtime 10-bit 4:4:4 AVIF, placeholder-free atomic publication, explicit result notification, split-device WGC readback ownership, and shared ABI 38/request-specific completion)

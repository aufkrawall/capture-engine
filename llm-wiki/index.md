...
Last cross-checked: 2026-07-21 (HDR/SDR file signaling and chroma, AMF/oneVPL/MF encoding, stable fail-closed monitor selection, and the existing current build, capture, graphics, audio, screenshot, and security state; see hardware-encoding.md, configuration.md, wgc-capture.md, current.md, and log/recent.md)

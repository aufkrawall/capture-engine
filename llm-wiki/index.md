...
- `dx12-overlay-third-party-coexistence.md`
  - Cross-API foreign hook-chain ownership for ReShade, OptiScaler, Special K, RTSS/Detours and established overlays; below-entry-chain deep interception, generic FSR final-ECL-batch topmost ordering with generation-latched marker activation, rotating per-submit slot guards, warm renderer retention across internal route flips, explicit baseline-retirement ownership, and single displayed-output FPS/history sampling, plus thread-quiesced patching, proxy exclusions, resident pass-through, and DX12/FG provenance. Last verified 2026-08-14.

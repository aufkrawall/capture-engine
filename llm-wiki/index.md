...
Last cross-checked: 2026-07-01 (updated: WGC producer-only cadence cap, hardware-cursor-preserving WGC cursor policy with encoder-side cursor composition, source-rate smoothness reservoir sizing, millisecond-capped smoothness diagnostics, and source-coverage best-effort logging)

...
Last cross-checked: 2026-06-05 (WGC live scheduler rebase and exact-stop drain guard)
Stale-risk: medium
...
- `WGC CFR live scheduler rebase`: live scheduler skipped old WGC visual ticks after the live-window debt bound was exceeded. This prevents old ticks from being owed at stop; inspect the count for smoothness impact under overload.

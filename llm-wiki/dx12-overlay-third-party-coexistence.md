...
- `[Overlay] dx12_focus_analysis=true` (config) → in-process residency flight recorder + present-gap; dumps on stall/device-removal. Logs: `DX12 ANALYSIS:`. Code: `DX12_UpdateFocusAnalysis`/`DX12_DumpFocusAnalysisRing` in `dx12_hook.cpp`.

...
Last cross-checked: 2026-06-09 (RESOLVED: x86 DX12 no-vsync `dx12_test` DEVICE_HUNG fixed by rendering x86 DX12 overlay text as native solid glyph-span geometry; see `handoff-dx12-32bit-crash.md` and `log/recent.md` 2026-06-09.)

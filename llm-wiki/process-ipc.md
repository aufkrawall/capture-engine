...
Last cross-checked: 2026-08-01 (media-owned finalization completion and recording health, restricted process channels, immutable per-recording media evidence, limited-query process identity, non-inject sensor targets, accept-before-finalize media stops, Explorer tray recovery, and exact shared-memory ABI/build publication/isolation)

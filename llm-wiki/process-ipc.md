...
- ABI 38 intentionally requires a fresh target process after installation; an already injected older DLL cannot hot-upgrade its compiled mapping name/layout/build identity. Fresh runtime validation of the media-owned completion notification and recording-health publication remains pending.

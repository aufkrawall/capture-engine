...
bool InitDX11(HWND hwnd) {
    ...
    if (FAILED(D3D11CreateDeviceAndSwapChain(nullptr, D3D_DRIVER_TYPE_HARDWARE, nullptr, flags, featureLevels, 1,
...
int main(int argc, char* argv[]) {
    ...
    WNDCLASSEXW wc = {sizeof(WNDCLASSEXW),
                      ...
                      nullptr};
    RegisterClassExW(&wc);
    HWND hwnd = CreateWindowW(WINDOW_CLASS, L"DX11 Test", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT,

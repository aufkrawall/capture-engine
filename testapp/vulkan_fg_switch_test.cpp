// Vulkan behavioral equivalent of dx12_fg_switch_test.exe.
// Streamline 2.11.1 provides DLSS SR/DLSS-G/Reflex; the signed FidelityFX SDK 1.1.4 Vulkan
// runtime provides non-ML FSR 3.1.4 SR/FG. The renderer and all SDKs share one Vulkan device.
...
#include "vulkan_fg_switch_fidelityfx.inl"
#include "vulkan_fg_switch_wsi.inl"
#include "vulkan_fg_switch_resources.inl"
#include "vulkan_fg_switch_transition.inl"
#include "vulkan_fg_switch_renderer.inl"

...
constexpr const wchar_t *PIPE_NAME_INJECT =
    L"\\\\.\\pipe\\CaptureEngine_Inject";
constexpr const wchar_t *PIPE_NAME_MEDIA = L"\\\\.\\pipe\\CaptureEngine_Media";
constexpr const wchar_t *PIPE_NAME_LIMITER =
    L"\\\\.\\pipe\\CaptureEngine_Limiter";
...
public:
  ...
  bool PollCommand(ProcessCommand &outCmd, char *outPayload = nullptr,
...
public:
  ...
  bool SendCommand(ProcessCommand cmd, const char *payload = nullptr,
                   ProcessResponse *outResponse = nullptr,

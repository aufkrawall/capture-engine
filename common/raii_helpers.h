...
public:
    ...
    // Move-only
    HandleGuard(HandleGuard&& o) noexcept : h_(o.h_) { o.h_ = INVALID_HANDLE_VALUE; }
...
public:
    ...
    ScopeGuard(ScopeGuard&& o) noexcept : func_(std::move(o.func_)), active_(o.active_) { o.active_ = false; }

...
static constexpr uint32_t SHARED_MEMORY_VERSION = 61;
...
static constexpr const wchar_t* SHARED_MEM_BASE_NAME = L"Local\\CE_SM_61_";
// Discovery shared memory - fixed name, contains inject process PID for fast
// lookup
static constexpr const wchar_t* SHARED_MEM_DISCOVERY = L"Local\\CE_Disc_61";

...
static constexpr uint32_t SHARED_MEMORY_VERSION = 62;
...
static constexpr const wchar_t* SHARED_MEM_BASE_NAME = L"Local\\CE_SM_62_";
// Discovery shared memory - fixed name, contains inject process PID for fast
// lookup
static constexpr const wchar_t* SHARED_MEM_DISCOVERY = L"Local\\CE_Disc_62";

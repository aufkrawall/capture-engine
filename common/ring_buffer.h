 ...
 *
 * This template provides a type-safe, lock-free ring buffer for SPSC (Single
 * Producer Single Consumer) scenarios. It supports both fixed-size arrays (for
 * shared memory) and dynamic storage.
 *
 * Features:

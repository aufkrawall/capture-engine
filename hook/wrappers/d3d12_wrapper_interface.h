...
// ============================================================================
// The D3D12 wrapper needs access to graphics config for AF/mip bias overrides.
// Since the wrapper is compiled with MSVC and the hook with MinGW, we use a
// callback mechanism to avoid ABI issues.

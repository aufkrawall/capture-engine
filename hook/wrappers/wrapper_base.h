...
template <typename T> inline T *DeWrap(T *p) {
  if (!p)
    return nullptr;
  T *pReal = nullptr;
  ...
  if (SUCCEEDED(
          p->QueryInterface(IID_CWrapD3D12CommandQueue, (void **)&pReal))) {
    pReal->Release();
    return pReal;
  }
...
static const GUID IID_IFfxFrameInterpolationSwapChain = {
    ...
    0x4D87,
    0x4E98,
    {0x82, 0x1F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01}};
...
static const GUID IID_IFrameInterpolationSwapChainDX12 = {
    ...
    0x4D87,
    0x4E98,
    {0x82, 0x1F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02}};
...
static const GUID IID_StreamlineUnwrap = {
    ...
    0xafda,
    0x4f5f,
    {0xad, 0xa9, 0xbf, 0x66, 0xcc, 0xc6, 0x2b, 0x6e}};

/**
 * D3D12 CommandQueue Wrapper
 *
 * Intercepts ExecuteCommandLists for capture functionality.
 */
...
/**
 * CWrapD3D12CommandQueue - Wraps ID3D12CommandQueue
 */
...
public:
    ...
    ID3D12CommandQueue* GetReal() const {
        return m_pReal;
    }

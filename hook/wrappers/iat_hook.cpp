...
bool InitializeD3D12Hooks()
{
    ...
    if (hD3D12) {
        ...
        // preload it here, the delay-load mechanism could crash due to thread safety issues.
        ...
        void* dummy;
        bool patchResult =
            PatchIATAllModules("d3d12.dll", "D3D12CreateDevice", (void*)Wrapped_D3D12CreateDevice, &dummy);
        if (!patchResult) {

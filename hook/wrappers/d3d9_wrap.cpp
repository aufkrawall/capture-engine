...
ULONG STDMETHODCALLTYPE CWrapDirect3D9::AddRef() { return InterlockedIncrement(&m_RefCount); }
...
UINT STDMETHODCALLTYPE CWrapDirect3D9::GetAdapterCount() { return m_pReal->GetAdapterCount(); }

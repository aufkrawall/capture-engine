 ...
 * D3D9 Device Wrapper
 *
 * Wraps IDirect3DDevice9 and IDirect3DDevice9Ex for:
 * - VSync override via Present parameters
 * - Anisotropic filtering override via SetSamplerState
 */
...
/**
 * CWrapD3D9Device - Wraps IDirect3DDevice9 and IDirect3DDevice9Ex
 */
class CWrapD3D9Device : public IDirect3DDevice9Ex {
public:
    CWrapD3D9Device(IDirect3DDevice9* pReal, bool isEx = false);
    virtual ~CWrapD3D9Device();

    IDirect3DDevice9* GetReal() const { return m_pReal; }
    ...
    // Present - KEY OVERRIDE for VSync
    ...
    // SetSamplerState - KEY OVERRIDE for AF
    ...
    HRESULT STDMETHODCALLTYPE SetVertexShaderConstantF(UINT StartRegister, const float* pConstantData,
    ...
    HRESULT STDMETHODCALLTYPE GetStreamSource(UINT StreamNumber, IDirect3DVertexBuffer9** ppStreamData,
                                              UINT* OffsetInBytes, UINT* pStride) override;
    ...
    HRESULT STDMETHODCALLTYPE SetPixelShaderConstantF(UINT StartRegister, const float* pConstantData,
                                                      UINT Vector4fCount) override;
    ...
    // ========================================================================
    // IDirect3DDevice9Ex Methods (if Ex device)
    // ========================================================================

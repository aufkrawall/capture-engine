...
CWrapD3D11Device::CWrapD3D11Device(ID3D11Device *pReal)
    : m_pReal(pReal), m_pReal1(nullptr), m_pReal2(nullptr), m_pReal3(nullptr),
      m_pReal4(nullptr), m_pReal5(nullptr), m_RefCount(1), m_Version(0),
      m_pWrappedContext(nullptr) {
  if (pReal) {
    pReal->AddRef();
    PromoteInterfaces();
  }
  WrapperLog("D3D11 Device Wrapper: Created (real=%p, version=%d)", pReal,
             m_Version);
}
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::QueryInterface(REFIID riid,
                                                           void **ppvObj) {
  if (!ppvObj)
    return E_POINTER;
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateBuffer(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateTexture1D(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateTexture2D(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateTexture3D(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateShaderResourceView(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateUnorderedAccessView(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateRenderTargetView(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateDepthStencilView(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateInputLayout(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateVertexShader(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateGeometryShader(
    const void *pShaderBytecode, SIZE_T BytecodeLength,
...
CWrapD3D11Device::CreateGeometryShaderWithStreamOutput(
    const void *pShaderBytecode, SIZE_T BytecodeLength,
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreatePixelShader(
    const void *pShaderBytecode, SIZE_T BytecodeLength,
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateHullShader(
    const void *pShaderBytecode, SIZE_T BytecodeLength,
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateDomainShader(
    const void *pShaderBytecode, SIZE_T BytecodeLength,
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateComputeShader(
    const void *pShaderBytecode, SIZE_T BytecodeLength,
...
HRESULT STDMETHODCALLTYPE
CWrapD3D11Device::CreateClassLinkage(ID3D11ClassLinkage **ppLinkage) {
  return m_pReal->CreateClassLinkage(ppLinkage);
}

HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateBlendState(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateDepthStencilState(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateRasterizerState(
...
HRESULT STDMETHODCALLTYPE
CWrapD3D11Device::CreateSamplerState(const D3D11_SAMPLER_DESC *pSamplerDesc,
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateQuery(
    const D3D11_QUERY_DESC *pQueryDesc, ID3D11Query **ppQuery) {
  return m_pReal->CreateQuery(pQueryDesc, ppQuery);
}

HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreatePredicate(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateCounter(
    const D3D11_COUNTER_DESC *pCounterDesc, ID3D11Counter **ppCounter) {
  return m_pReal->CreateCounter(pCounterDesc, ppCounter);
}

HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateDeferredContext(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::OpenSharedResource(
...
HRESULT STDMETHODCALLTYPE
CWrapD3D11Device::CheckFormatSupport(DXGI_FORMAT Format, UINT *pFormatSupport) {
  return m_pReal->CheckFormatSupport(Format, pFormatSupport);
}

HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CheckMultisampleQualityLevels(
...
CWrapD3D11Device::CheckCounterInfo(D3D11_COUNTER_INFO *pCounterInfo) {
  m_pReal->CheckCounterInfo(pCounterInfo);
}

HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CheckCounter(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CheckFeatureSupport(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::GetPrivateData(REFGUID guid,
                                                           UINT *pDataSize,
                                                           void *pData) {
  return m_pReal->GetPrivateData(guid, pDataSize, pData);
}

HRESULT STDMETHODCALLTYPE CWrapD3D11Device::SetPrivateData(REFGUID guid,
                                                           UINT DataSize,
                                                           const void *pData) {
...
HRESULT STDMETHODCALLTYPE
CWrapD3D11Device::SetPrivateDataInterface(REFGUID guid, const IUnknown *pData) {
...
void STDMETHODCALLTYPE CWrapD3D11Device::GetImmediateContext(
...
void STDMETHODCALLTYPE CWrapD3D11Device::GetImmediateContext1(
  ...
  if (m_pWrappedContext) {
    m_pWrappedContext->AddRef();
    *ppImmediateContext =
        static_cast<ID3D11DeviceContext1 *>(m_pWrappedContext);
  } else {
    m_pReal1->GetImmediateContext1(ppImmediateContext);
  }
}

HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateDeferredContext1(
...
HRESULT STDMETHODCALLTYPE
CWrapD3D11Device::CreateBlendState1(const D3D11_BLEND_DESC1 *pBlendStateDesc,
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateRasterizerState1(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateDeviceContextState(
  ...
  if (!m_pReal1)
    return E_NOINTERFACE;
  return m_pReal1->CreateDeviceContextState(
      Flags, pFeatureLevels, FeatureLevels, SDKVersion, EmulatedInterface,
      pChosenFeatureLevel, ppContextState);
}

HRESULT STDMETHODCALLTYPE CWrapD3D11Device::OpenSharedResource1(
    HANDLE hResource, REFIID returnedInterface, void **ppResource) {
  if (!m_pReal1)
    return E_NOINTERFACE;
  return m_pReal1->OpenSharedResource1(hResource, returnedInterface,
                                       ppResource);
}

HRESULT STDMETHODCALLTYPE CWrapD3D11Device::OpenSharedResourceByName(
    LPCWSTR lpName, DWORD dwDesiredAccess, REFIID returnedInterface,
    void **ppResource) {
  if (!m_pReal1)
    return E_NOINTERFACE;
  return m_pReal1->OpenSharedResourceByName(lpName, dwDesiredAccess,
                                            returnedInterface, ppResource);
}

// ID3D11Device2
void STDMETHODCALLTYPE CWrapD3D11Device::GetImmediateContext2(
  ...
  if (m_pWrappedContext) {
    m_pWrappedContext->AddRef();
    *ppImmediateContext =
        static_cast<ID3D11DeviceContext2 *>(m_pWrappedContext);
  } else {
    m_pReal2->GetImmediateContext2(ppImmediateContext);
  }
}

HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateDeferredContext2(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CheckMultisampleQualityLevels1(
    DXGI_FORMAT Format, UINT SampleCount, UINT Flags, UINT *pNumQualityLevels) {
  if (!m_pReal2)
    return E_NOINTERFACE;
  return m_pReal2->CheckMultisampleQualityLevels1(Format, SampleCount, Flags,
                                                  pNumQualityLevels);
}

// ID3D11Device3
HRESULT STDMETHODCALLTYPE
CWrapD3D11Device::CreateTexture2D1(const D3D11_TEXTURE2D_DESC1 *pDesc1,
...
HRESULT STDMETHODCALLTYPE
CWrapD3D11Device::CreateTexture3D1(const D3D11_TEXTURE3D_DESC1 *pDesc1,
                                   const D3D11_SUBRESOURCE_DATA *pInitialData,
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateRasterizerState2(
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateShaderResourceView1(
    ID3D11Resource *pResource, const D3D11_SHADER_RESOURCE_VIEW_DESC1 *pDesc1,
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateUnorderedAccessView1(
    ID3D11Resource *pResource, const D3D11_UNORDERED_ACCESS_VIEW_DESC1 *pDesc1,
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateRenderTargetView1(
    ID3D11Resource *pResource, const D3D11_RENDER_TARGET_VIEW_DESC1 *pDesc1,
...
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateQuery1(
...
void STDMETHODCALLTYPE CWrapD3D11Device::GetImmediateContext3(
  ...
  if (m_pWrappedContext) {
    m_pWrappedContext->AddRef();
    *ppImmediateContext =
        static_cast<ID3D11DeviceContext3 *>(m_pWrappedContext);
  } else {
    m_pReal3->GetImmediateContext3(ppImmediateContext);
  }
}

HRESULT STDMETHODCALLTYPE CWrapD3D11Device::CreateDeferredContext3(
...
void STDMETHODCALLTYPE CWrapD3D11Device::WriteToSubresource(
    ID3D11Resource *pDstResource, UINT DstSubresource, const D3D11_BOX *pDstBox,
    const void *pSrcData, UINT SrcRowPitch, UINT SrcDepthPitch) {
  if (m_pReal3)
    m_pReal3->WriteToSubresource(pDstResource, DstSubresource, pDstBox,
                                 pSrcData, SrcRowPitch, SrcDepthPitch);
}

void STDMETHODCALLTYPE CWrapD3D11Device::ReadFromSubresource(
    void *pDstData, UINT DstRowPitch, UINT DstDepthPitch,
    ID3D11Resource *pSrcResource, UINT SrcSubresource,
    const D3D11_BOX *pSrcBox) {
  if (m_pReal3)
    m_pReal3->ReadFromSubresource(pDstData, DstRowPitch, DstDepthPitch,
                                  pSrcResource, SrcSubresource, pSrcBox);
}

// ID3D11Device4
HRESULT STDMETHODCALLTYPE
CWrapD3D11Device::RegisterDeviceRemovedEvent(HANDLE hEvent, DWORD *pdwCookie) {
  if (!m_pReal4)
    return E_NOINTERFACE;
...
void STDMETHODCALLTYPE
CWrapD3D11Device::UnregisterDeviceRemoved(DWORD dwCookie) {
  if (m_pReal4)
    m_pReal4->UnregisterDeviceRemoved(dwCookie);
}

// ID3D11Device5
HRESULT STDMETHODCALLTYPE CWrapD3D11Device::OpenSharedFence(
    HANDLE hFence, REFIID ReturnedInterface, void **ppFence) {
  if (!m_pReal5)
    return E_NOINTERFACE;
...
HRESULT STDMETHODCALLTYPE
CWrapD3D11Device::CreateFence(UINT64 InitialValue, D3D11_FENCE_FLAG Flags,

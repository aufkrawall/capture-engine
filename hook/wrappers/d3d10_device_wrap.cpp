...
ULONG STDMETHODCALLTYPE CWrapD3D10Device::AddRef() { return InterlockedIncrement(&m_RefCount); }
...
void STDMETHODCALLTYPE CWrapD3D10Device::GSSetShader(ID3D10GeometryShader* pShader) { m_pReal->GSSetShader(pShader); }
...
UINT STDMETHODCALLTYPE CWrapD3D10Device::GetCreationFlags() { return m_pReal->GetCreationFlags(); }

...
public:
  CWrapD3D11DeviceContext(ID3D11DeviceContext *pReal,
  ...
  Map(ID3D11Resource *pResource, UINT Subresource, D3D11_MAP MapType,
      UINT MapFlags, D3D11_MAPPED_SUBRESOURCE *pMappedResource) override;
  void STDMETHODCALLTYPE Unmap(ID3D11Resource *pResource,
  ...
  HRESULT STDMETHODCALLTYPE GetData(ID3D11Asynchronous *pAsync, void *pData,
                                    UINT DataSize, UINT GetDataFlags) override;
  ...
  void STDMETHODCALLTYPE OMSetDepthStencilState(
      ID3D11DepthStencilState *pDepthStencilState, UINT StencilRef) override;
  ...
  void STDMETHODCALLTYPE DrawIndexedInstancedIndirect(
      ID3D11Buffer *pBufferForArgs, UINT AlignedByteOffsetForArgs) override;
  ...
  void STDMETHODCALLTYPE RSSetScissorRects(UINT NumRects,
                                           const D3D11_RECT *pRects) override;
  ...
  void STDMETHODCALLTYPE SOGetTargets(UINT NumBuffers,
                                      ID3D11Buffer **ppSOTargets) override;
  void STDMETHODCALLTYPE
  ...
  void STDMETHODCALLTYPE UpdateTiles(
      ...
      const void *pSourceTileData, UINT Flags) override;
  HRESULT STDMETHODCALLTYPE ResizeTilePool(ID3D11Buffer *pTilePool,
  ...
  // ========================================================================
  void STDMETHODCALLTYPE Flush1(D3D11_CONTEXT_TYPE ContextType,
                                HANDLE hEvent) override;
  void STDMETHODCALLTYPE
  SetHardwareProtectionState(BOOL HwProtectionEnable) override;
  void STDMETHODCALLTYPE
  GetHardwareProtectionState(BOOL *pHwProtectionEnable) override;

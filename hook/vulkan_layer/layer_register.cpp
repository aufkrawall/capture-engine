...
int wmain(int argc, wchar_t* argv[]) {
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (arg == L"--register") doRegister = true;
        else if (arg == L"--unregister") doUnregister = true;
        else if (arg == L"--status") doStatus = true;
        else if (arg == L"--all-users") forAllUsers = true;
        else if (arg == L"--help") {
            PrintUsage(argv[0]);
            return 0;
        }

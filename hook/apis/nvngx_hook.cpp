...
void EnsureVTableHooks(NVSDK_NGX_Parameter* pParams)
{
    ...
    if (cfg.forceRayReconstruction) {
        ...
        // Force init result = 0 (Success/Supported check usually looks for 0 or 1 depending on param, but
        // FeatureInitResult is often a success code 0 or 1) Actually FeatureInitResult usually stores the
        // NVSDK_NGX_Result. 1 = Success.

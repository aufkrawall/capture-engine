...
public:
    ...
    HRESULT STDMETHODCALLTYPE QueryInterface(REFIID riid, void** ppvObj) override
    {
        ...
        if (riid == IID_OverlaySwapChainWrapper || riid == __uuidof(IUnknown) || riid == __uuidof(IDXGIObject) ||
    ...
    HRESULT STDMETHODCALLTYPE GetHwnd(HWND* pHwnd) override { return m_pReal1 ? m_pReal1->GetHwnd(pHwnd) : E_NOTIMPL; }

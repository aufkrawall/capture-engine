...
static std::string CleanHardwareName(std::string raw, bool isGpu) {
    ...
    if (isGpu) {
        ...
        for (const auto& t : tokens) {
            ...
            bool skip = false;
            const char* blocklist[] = { "NVIDIA", "AMD", "INTEL", "GEFORCE", "RADEON", "GRAPHICS", "CORPORATION", "CO.", "LTD", "TM", "R", "ADAPTER" };
        ...
        if (result.empty()) {
             for (const auto& t : tokens) {
                ...
                bool skip = false;
                const char* blocklist[] = { "NVIDIA", "AMD", "INTEL", "GEFORCE", "RADEON", "GRAPHICS", "CORPORATION", "CO.", "LTD", "TM", "R" };
                for (const char* block : blocklist) { if (upperT == block) skip = true; }
        ...
        for (const auto& t : tokens) {
            ...
            const char* blocklist[] = { 
                "AMD", "INTEL", "RYZEN", "CORE", "PROCESSOR", "CPU", "APU", "SOC", "GEN", "COMPUTE", "MICROSOFT",
                "DUAL", "QUAD", "HEXA", "OCTA", "EIGHT", "SIX", "TEN", "TWELVE", "SIXTEEN", "TWENTY",
                "R", "TM", "CO.", "LTD."
            };
            for (const char* block : blocklist) { if (upperT == block) skip = true; }

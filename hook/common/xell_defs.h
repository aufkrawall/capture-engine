...
typedef xell_result_t(__cdecl* PFN_xellD3D12CreateContext)(void* pDevice, xell_context_handle_t* pContext);
typedef xell_result_t(__cdecl* PFN_xellDestroyContext)(xell_context_handle_t context);
typedef xell_result_t(__cdecl* PFN_xellSetSleepMode)(xell_context_handle_t context, const xell_sleep_params_t* param);
typedef xell_result_t(__cdecl* PFN_xellSleep)(xell_context_handle_t context, uint32_t frame_id);
typedef xell_result_t(__cdecl* PFN_xellSetLoggingCallback)(xell_context_handle_t context, xell_logging_level_t level,

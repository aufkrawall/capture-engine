...
public:
    ...
    bool ClearFpsLimit() {
        ...
        HookLogImportant("ReflexLimiter: Clear FPS limit failed (status=%d boost=%u markers=%u lowLatency=%u)",
                         status, params.bLowLatencyBoost, params.bUseMarkersToOptimize, params.bLowLatencyMode);

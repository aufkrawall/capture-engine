...
void CaptureManager::SetCaptureEnabled(bool enabled) { m_CaptureEnabled = enabled; }
...
SharedCaptureD3D11::SharedCaptureD3D11()
    : m_SharedHandles{nullptr, nullptr}, m_WriteIndex(0), m_FrameCounter(0), m_Active(false)
{
...
SharedCaptureD3D12::SharedCaptureD3D12()
    : m_SharedHandles{nullptr, nullptr}, m_FenceShareHandle(nullptr), m_FenceEvent(nullptr), m_FenceValue(0),
      m_FenceValues{0, 0}, m_WriteIndex(0), m_FrameCounter(0), m_Active(false)
{
    ZeroMemory(&m_CurrentFrame, sizeof(m_CurrentFrame));
}
